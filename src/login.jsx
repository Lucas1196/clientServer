        ...
        return (
            <form onSubmit={this.handleSubmit} className="col-6 offset-3">
                ...
                <div className="noAccount">
                    If you don't have an account, <a href="register.html" title="Register" className="btn-register">Register</a> !
                </div>
            </form>
        );
    }
}
ReactDOM.render( <LoginForm />, document.getElementById('containerLogin'));